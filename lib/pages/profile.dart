                                ...
                                StreamBuilder(
                                  ...
                                  builder: (context,
                                    ...
                                    if (snapshot.hasData) {
                                      ...
                                      return buildCount(
                                          "Нийтлэл", docs?.length ?? 0);
                                    } else {
                                      return buildCount("Нийтлэл", 0);
                                    }
                                  },
                                ),
                                Padding(
                                ...
                                StreamBuilder(
                                  ...
                                  builder: (context,
                                    ...
                                    if (snapshot.hasData) {
                                      ...
                                      List<DocumentSnapshot> docs = snap.docs;
                                      return buildCount(
                                          "Уншигч", docs?.length ?? 0);
                                    } else {
                                      return buildCount("Уншигч", 0);
                                    }
                                  },
                                ),
                                Padding(
                                ...
                                StreamBuilder(
                                  ...
                                  builder: (context,
                                    ...
                                    if (snapshot.hasData) {
                                      ...
                                      List<DocumentSnapshot> docs = snap.docs;
                                      return buildCount(
                                          "Дагагч", docs?.length ?? 0);
                                    } else {
                                      return buildCount("Дагагч", 0);
                                    }
                                  },
                                ),
                              ],
